...
Revision ID: b29d781daad7
Revises: 
Create Date: 2025-09-22 15:22:09.143563
...
def upgrade() -> None:
    ...
    op.create_index('ix_book_genre', 'book', ['genre'], unique=False)
    ...
    op.create_index(op.f('ix_loan_book_id'), 'loan', ['book_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_loan_book_id'), table_name='loan')
    op.drop_table('loan')
